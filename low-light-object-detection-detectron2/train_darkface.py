...
def main(args):
    ...
    register_coco_instances("darkface_train", {}, "data/darkface_train.json", "data/darkface/images")
    register_coco_instances("darkface_val", {}, "data/darkface_test.json", "data/darkface/images")
