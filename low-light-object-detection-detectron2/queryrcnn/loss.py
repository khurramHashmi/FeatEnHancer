...
class SetCriterion(nn.Module):
    ...
    def loss_labels(self, outputs, targets, indices, num_boxes, enhanced_image, log=False):
    ...
    def loss_boxes(self, outputs, targets, indices, num_boxes, enhanced_image):
    ...
    def get_loss(self, loss, outputs, targets, indices, num_boxes, enhanced_image, **kwargs):
        loss_map = {
            'labels': self.loss_labels,
            'boxes': self.loss_boxes,
        }
        assert loss in loss_map, f'do you really want to compute {loss} loss?'
        return loss_map[loss](outputs, targets, indices, num_boxes, enhanced_image, **kwargs)

    def forward(self, outputs, targets, enhanced_image):
        ...
        for loss in self.losses:
            losses.update(self.get_loss(loss, outputs, targets, indices, num_boxes, enhanced_image))
            ...
            for i, aux_outputs in enumerate(outputs['aux_outputs']):
                ...
                for loss in self.losses:
                    ...
                    if loss == 'labels':
                        ...
                        kwargs = {'log': False}
                    l_dict = self.get_loss(loss, aux_outputs, targets, indices, num_boxes, enhanced_image, **kwargs)
